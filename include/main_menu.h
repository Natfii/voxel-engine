...
struct MenuResult {
    ...
    int spawnRadius = 4;       // Initial spawn area radius in chunks (if NEW_GAME) - GPU warm-up ensures 60 FPS
...
private:
    ...
    int spawnRadiusSlider = 4;  // Initial spawn radius (2-8 chunks) - GPU warm-up ensures 60 FPS
